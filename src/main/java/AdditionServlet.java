...
//    type doGet and tab, and it will set up for you.
    @Override
...
//        default return is a string so have to type cohearse
//        PrintWriter sets up to see in browser. getWriter gets writer form the response